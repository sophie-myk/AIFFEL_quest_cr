...
회고
  ...
  플러터를 책과 문자로만 접할때는 이게 어떻게 구현되는건지 도무지 감이 서지 않았는데, 직접 코드를 작성하고 구현된 가상화면을 보니 앞으로의 진행방향을 조금 알 수 있을 것 같았다.
  null safety를 통해 null값 참조를 못하도록 해서 런타입 에러를 방지하고, 물음표를 적절히 활용하여 객체를 잘 지정해주는 것이 중요한 것 같다.
